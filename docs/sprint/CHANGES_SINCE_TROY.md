...
| UI 冒烟（UIA）进仓库并上 CI | `e425160` `3e0e27f` `d34b09b` `064d53d` `7d3cb1c` | `tests/ui-smoke` 5 个场景（示例→导出、作废横幅、.anc 反推→重切→导出、库文件损坏恢复、损坏工程）；托管 Windows Runner 上 5/5；`evaluate-product.ps1` 重新可用（99/100） |
