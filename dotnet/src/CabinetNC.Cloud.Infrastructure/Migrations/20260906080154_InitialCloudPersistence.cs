...
{
    /// <inheritdoc />
    public partial class InitialCloudPersistence : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InputObjectKey = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    InputSha256 = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    InputStoredAtUtc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    ResultObjectKey = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ComputeJobs", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditEvents_TenantId_CreatedAtUtc",
                table: "AuditEvents",
                columns: new[] { "TenantId", "CreatedAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_ComputeJobs_Status_LockedUntilUtc_CreatedAtUtc",
                table: "ComputeJobs",
                columns: new[] { "Status", "LockedUntilUtc", "CreatedAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_ComputeJobs_TenantId_CreatedAtUtc",
                table: "ComputeJobs",
                columns: new[] { "TenantId", "CreatedAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_ComputeJobs_TenantId_UserId_IdempotencyKey",
                table: "ComputeJobs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefreshTokens_DeviceId_RevokedAtUtc",
                table: "RefreshTokens",
                columns: new[] { "DeviceId", "RevokedAtUtc" });
