...
public static class PartsInPartPacker
{
    ...
    public static HashSet<(string A, string B)> IgnoreCollisionPairs(IEnumerable<PartInPartSlot> slots) =>
        PartsInPartGeometry.IgnoreCollisionPairs(slots);
    ...
    public static bool TryUsableVoid(
        ...
        out double width,
        out double height) =>
        PartsInPartGeometry.TryUsableVoid(host, hostOx, hostOy, hostRotDeg, featureId, clearanceMm, out minX, out minY, out width, out height);
